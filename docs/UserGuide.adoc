...
Example: `tag ls` will display all entries in ResuMaker.

Example: `tag ls ~work #java` list all the `~work` entries tagged with `#java`
...
Example: `tag add 10 ~work #java` add tag `#java` and category `~work` to entry 10.
...
Example: `tag rm 1 ~work #java` remove category `~work` and tag `#java` from entry 1.

Example: `tag rm 10` remove all tags and categories from entry 10.
...
Example: `tag rt 1 ~work #java` remove all tags and categories from entry 1, adding tag `#java` and category `~work` to entry 1.
