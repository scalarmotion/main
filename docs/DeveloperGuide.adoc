...
6. System saves a markdown file containing a resume based on the template and the entries specified by the template
+
Use case ends.
...
[[section]] Section::
A distinct category of a generated resume (Work Experience, Project, etc)
