...
===== CategoryManager
To use `CategoryManager` to filter out relevant entries, there are 2 main functions to keep in mind:

* `setFilter(Predicate<ResumeEntry>)`: sets the filtering criteria for the list of entries
